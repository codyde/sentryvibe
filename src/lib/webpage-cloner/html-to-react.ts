...
`;
  ...
  // Create App.css with all extracted CSS
  const appCss = `/* Cloned from: ${clonedData.originalUrl} */

/* All original CSS from the cloned page */
${clonedData.css}

/* Minimal wrapper styles */
.cloned-page {
  /* Let the cloned content define its own styling */
}
`;

  console.log('✅ HTML converted to React');
  console.log(`   CSS size: ${(clonedData.css.length / 1024).toFixed(0)}KB`);
