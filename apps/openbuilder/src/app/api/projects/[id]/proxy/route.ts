...
import { httpProxyManager, buildWebSocketServer } from '@openbuilder/agent-core/lib/websocket';
...
export async function GET(
  ...
  try {
    ...
    if (frontendIsLocal) {
      ...
      // User accessing frontend via remote URL (e.g., openbuilder.up.railway.app)
...
(function() {
  ...
  try {
    ...
    console.warn('[OpenBuilder] Path normalization failed:', e);
  }
