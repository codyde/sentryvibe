/**
 * Client-safe build helper functions
 * These utilities are used in client components and must not import any server-side dependencies
 */

import type { BuildOperationType } from '@/types/generation';
