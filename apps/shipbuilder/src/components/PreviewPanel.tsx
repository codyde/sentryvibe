...
import { toggleSelectionMode } from '@shipbuilder/agent-core/lib/selection/injector';
...
export default function PreviewPanel({ 
  ...
  useEffect(() => {
    const handleMessage = (e: MessageEvent) => {
      if (e.data.type === 'shipbuilder:ready') {
  ...
  useEffect(() => {
    const handleMessage = (e: MessageEvent) => {
      if (e.data.type === 'shipbuilder:element-selected') {
