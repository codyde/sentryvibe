    ...
    >
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-zinc-400">
          Install the ShipBuilder CLI to run builds on your machine
        </p>
      </div>

      {/* Install command */}
      <TerminalCodeBlock 
        code="curl -fsSL https://shipbuilder.app/install | bash" 
        title="Install ShipBuilder CLI"
      />
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              The <code className="px-1.5 py-0.5 bg-zinc-800 rounded text-theme-accent">shipbuilder</code> CLI 
              allows you to run ShipBuilder locally, or start this runner to deploy using the SaaS ShipBuilder. 
