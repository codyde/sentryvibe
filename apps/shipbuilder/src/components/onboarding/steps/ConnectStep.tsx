...
export function ConnectStep({ runnerKey, onNext, onBack, onSkip }: ConnectStepProps) {
  ...
  const baseCommand = `shipbuilder runner --secret ${runnerKey}`;
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <ul className="text-xs text-amber-200/80 space-y-1">
                  ...
                  <li>Try running <code className="px-1 bg-black/30 rounded">shipbuilder --version</code> to verify installation</li>
                </ul>
              </div>
            </div>
          </motion.div>
