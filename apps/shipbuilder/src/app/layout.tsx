...
const isLocalMode = process.env.SHIPBUILDER_LOCAL_MODE === "true";
...
export const metadata: Metadata = {
  title: "ShipBuilder - Think it. Build it. Ship it.",
  ...
  metadataBase: new URL("https://shipbuilder.app"),
  openGraph: {
    title: "ShipBuilder - Think it. Build it. Ship it.",
    description: "Build and ship applications locally. Build cool things, prototype new ideas, break them, and fix it faster with Sentry.",
    url: "https://shipbuilder.app",
    siteName: "ShipBuilder",
    type: "website",
  },
  twitter: {
    card: "summary",
  ...
  keywords: ["AI", "app builder", "code generation", "full-stack", "developer tools", "shipbuilder"],
};
