...
import { httpProxyManager, buildWebSocketServer } from '@shipbuilder/agent-core/lib/websocket';
...
export async function GET(
  ...
  try {
    ...
    if (frontendIsLocal) {
      ...
      // User accessing frontend via remote URL (e.g., shipbuilder.up.railway.app)
...
(function() {
  ...
  try {
    ...
    console.warn('[ShipBuilder] Path normalization failed:', e);
  }
