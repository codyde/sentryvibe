...
import { deserializeGenerationState } from "@shipbuilder/agent-core/lib/generation-persistence";
import {
  detectOperationType,
  createFreshGenerationState,
  validateGenerationState,
  createInitialCodexSessionState,
} from "@shipbuilder/agent-core/lib/build-helpers";
import { processCodexEvent } from "@shipbuilder/agent-core/lib/agents/codex/events";
...
import { getClaudeModelLabel } from "@shipbuilder/agent-core/client";
import { deserializeTags, serializeTags } from "@shipbuilder/agent-core/lib/tags/serialization";
...
- Text: ${element.textContent?.substring(0, 100) || 'none'}` : '';
  ...
  // (apps/shipbuilder/src/app/api/runner/events/route.ts lines 638-710)
