...
exports.SELECTION_SCRIPT = void 0;
exports.injectSelectionScript = injectSelectionScript;
exports.toggleSelectionMode = toggleSelectionMode;
exports.SELECTION_SCRIPT = `
(function() {
 ...
 */
function injectSelectionScript(iframe) {
    try {
        ...
        script.textContent = exports.SELECTION_SCRIPT;
